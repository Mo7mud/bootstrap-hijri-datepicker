!(function (e, t) {
  ...
  (function (e, t) {
    ...
    for (console.log(L), a.ummalquraData[L] -= 1; p.length; )
      (t = p.pop()), (Y["i" + t + "o"] = D(Y["i" + t], t));
    for (; f.length; ) (t = f.pop()), (Y["i" + t + t] = y(Y["i" + t], 2));
    function k(e, t) {
      var a;
    ...
    if ("function" == typeof e.updateLocale) e.updateLocale("ar-sa", S);
    else {
      var H = e.locale();
      e.defineLocale("ar-sa", S), e.locale(H);
    }
    function j(t, a) {
      switch (t) {
        case "iDDDD":
      ...
      return (
        ...
        (function (e) {
          ...
          return null == n && null == s && null == r
            ...
            : ((n = n || 0),
              (s = s || 0),
              ((r = r || 1) < 1 || r > A.iDaysInMonth(n, s)) &&
                (e._isValid = !1),
              (a = C((t = O(n, s, r)).gy, t.gm, t.gd)),
              (e._hDiff = 0),
              ~~a.hy !== n && (e._hDiff += 1),
              ~~a.hm !== s && (e._hDiff += 1),
              ~~a.hd !== r && (e._hDiff += 1),
        ...
        if (
          ...
          return (function (e, t) {
            var a,
              ...
              d,
              o = e._f.length;
            if (0 === o) return F(new Date(NaN));
            for (a = 0; a < o; a += 1)
              (n = e._f[a]),
                (i = 0),
                (s = F(e._i, n, e._l, t)).isValid() &&
                  ((i += s._hDiff),
        ...
        (i = W(_)),
          (function (e) {
            var t,
              ...
              _ = o.length;
            for (t = 0; t < _; t += 1)
              (s = (j((a = o[t]), e).exec(r) || [])[0]) &&
                (r = r.slice(r.indexOf(s) + s.length)),
                Y[a] instanceof Function || ((d += a), s && (i += s));
            (e._i = i), (e._f = d);
          })(_),
          (a = "YYYY-MM-DD-" + _._f),
          (t =
    ...
    function C(e, t, n) {
      var s,
        ...
        l =
          ((s = (function (e, t, a) {
            var n =
              E(1461 * (e + E(t - 8, 6) + 100100), 4) +
              E(153 * z(t + 9, 12) + 2, 5) +
              a -
              34840408;
            return (n = n - E(3 * E(e + 100100 + E(t - 8, 6), 100), 4) + 752);
          })(e, t + 1, n)),
          (i = (function (e) {
            for (var t = 0; t < a.ummalquraData.length; t += 1)
              if (a.ummalquraData[t] > e) return t;
          })((r = s - 24e5))),
          (d = i + 16260),
          (o = Math.floor((d - 1) / 12)),
          (_ = o + 1),
          (u = d - 12 * o),
          (m = r - a.ummalquraData[i - 1] + 1),
          { hy: _, hm: u, hd: m });
      return (l.hm -= 1), l;
    }
    function O(e, t, n) {
      var s,
        ...
        _ =
          ((s = (function (e, t, n) {
            var s = J(e, t);
            return n + a.ummalquraData[s - 1] - 1 + 24e5;
          })(e, t + 1, n)),
          (r =
            (r = 4 * s + 139361631) +
            4 * E(3 * E(4 * s + 183187720, 146097), 4) -
            3908),
          (i = 5 * E(z(r, 1461), 4) + 308),
          (d = E(z(i, 153), 5) + 1),
          (o = z(E(i, 153), 12) + 1),
          { gy: E(r, 1461) - 100100 + E(8 - o, 6), gm: o, gd: d });
      return (_.gm -= 1), _;
    }
    return (
      k(A, e),
      (A.fn = v(e.fn)),
      (A.utc = function (e, t, a) {
        return F(e, t, a, !0);
      }),
      (A.fn.format = function (t) {
        var a,
          r,
          i = this;
        if (t) {
          ...
          M[t] ||
            (M[t] = (function (e) {
              var t,
                a = e.match(n),
                s = a.length;
              for (t = 0; t < s; t += 1) Y[a[t]] && (a[t] = Y[a[t]]);
              return function (n) {
                var r = "";
                for (t = 0; t < s; t += 1)
                  r +=
      ...
      (A.fn.iYear = function (t) {
        var a, n, s;
        return "number" == typeof t
          ? ((n = C(this.year(), this.month(), this.date())),
            (a = Math.min(n.hd, A.iDaysInMonth(t, n.hm))),
            T(this, (s = O(t, n.hm, a)).gy, s.gm, s.gd),
            (this.month() === s.gm &&
              this.date() === s.gd &&
              this.year() === s.gy) ||
            ...
            e.updateOffset(this),
            this)
          : C(this.year(), this.month(), this.date()).hy;
      }),
      (A.fn.iMonth = function (t) {
        var a, n, s;
        if (null != t) {
          if ("string" == typeof t) {
          ...
          return (
            (n = C(this.year(), this.month(), this.date())),
            (a = Math.min(n.hd, A.iDaysInMonth(n.hy, t))),
            this.iYear(n.hy + E(t, 12)),
            (t = z(t, 12)) < 0 && ((t += 12), this.iYear(this.iYear() - 1)),
            T(this, (s = O(this.iYear(), t, a)).gy, s.gm, s.gd),
            (this.month() === s.gm &&
              this.date() === s.gd &&
              this.year() === s.gy) ||
              T(this, s.gy, s.gm, s.gd),
        ...
        return C(this.year(), this.month(), this.date()).hm;
      }),
      (A.fn.iDate = function (t) {
        var a, n;
        return "number" == typeof t
          ? (T(
              this,
              (n = O(
                (a = C(this.year(), this.month(), this.date())).hy,
                a.hm,
                t
              )).gy,
              n.gm,
            ...
            e.updateOffset(this),
            this)
          : C(this.year(), this.month(), this.date()).hd;
      }),
      (A.fn.iDayOfYear = function (e) {
        var t =
          Math.round(
            (A(this).startOf("day") - A(this).startOf("iYear")) / 864e5
          ) + 1;
        return null == e ? t : this.add(e - t, "d");
      }),
      (A.fn.iDaysInMonth = function () {
        return parseInt(A(this).endOf("iMonth").format("iDD"));
      }),
      (A.fn.iWeek = function (e) {
        var t = P(
          this,
          this.localeData()._week.dow,
          this.localeData()._week.doy
      ...
      (A.fn.iYears = A.fn.iYear),
      (A.fn.iMonths = A.fn.iMonth),
      (A.fn.iDates = A.fn.iDate),
      (A.fn.iWeeks = A.fn.iWeek),
      (A.iDaysInMonth = function (e, t) {
        var n = J(e, t + 1);
        return a.ummalquraData[n] - a.ummalquraData[n - 1];
      }),
      (A.iConvert = { toHijri: C, toGregorian: O }),
      A
    );
    function E(e, t) {
      return ~~(e / t);
      ...
      var s,
        ...
        H = function () {
          var t,
              ...
              .append(
                ((u = e("<thead>").append(
                  e("<tr>")
                    ...
                    .append(
                      e("<th>")
                        .addClass("picker-switch almarai-bold")
            ...
            p = e("<li>")
              .addClass(
                "picker-switch almarai-bold" + (n.collapse ? " accordion-toggle" : "")
              )
              .append(
                (function () {
                  var t = [];
          ...
          for (
            ...
            t.push(
              e("<span>")
                ...
                .addClass("month almarai-regular")
                .text(a.format("MMM"))
            ),
              a.add(1, "months");
            ...
            : (void 0 !== i.val() && 0 !== i.val().trim().length
              ...
              (function () {
                ...
                for (
                  ...
                  t.append(e("<th>").addClass("dow almarai-regular").text(a.format("dd"))),
                    a.add(1, "days");
